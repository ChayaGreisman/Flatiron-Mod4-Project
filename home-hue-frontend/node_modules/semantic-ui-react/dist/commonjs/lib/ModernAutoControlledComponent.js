...
function (_React$Component) {
  (0, _inherits2["default"])(ModernAutoControlledComponent, _React$Component);
  ...
  (0, _createClass2["default"])(ModernAutoControlledComponent, null, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      ...
      if (getAutoControlledStateFromProps) {
        var computedState = getAutoControlledStateFromProps(props, (0, _objectSpread2["default"])({}, state, newStateFromProps), state); // We should follow the idea of getDerivedStateFromProps() and return only modified state
