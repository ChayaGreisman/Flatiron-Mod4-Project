...
function getSelectedIndex(config) {
  ...
  var enabledIndicies = (0, _reduce2["default"])(menuOptions, function (memo, item, index) {
  ...
  if (!selectedIndex || selectedIndex < 0) {
    ...
    newSelectedIndex = multiple ? firstIndex : (0, _findIndex2["default"])(menuOptions, ['value', value]) || enabledIndicies[0];
  } else if (multiple) {
