...
function (_Component) {
  ...
  function Dropdown() {
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "getSelectedItem", function () {
      ...
      return (0, _get2["default"])(options, "[".concat(selectedIndex, "]"));
    });
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "setSelectedIndex", function () {
      ...
      var newSelectedIndex = (0, _getSelectedIndex["default"])({
        additionLabel: _this.props.additionLabel,
        additionPosition: _this.props.additionPosition,
        allowAdditions: _this.props.allowAdditions,
        deburr: _this.props.deburr,
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "open", function () {
      ...
      var triggerSetState = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    ...
    (0, _defineProperty2["default"])((0, _assertThisInitialized2["default"])(_this), "renderText", function () {
      ...
      if (text) {
        ...
        _text = (0, _get2["default"])(_this.getSelectedItem(), 'text');
      } else if (hasValue) {
        _text = (0, _get2["default"])(_this.getItemByValue(value), 'text');
      }
  ...
  (0, _createClass2["default"])(Dropdown, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (process.env.NODE_ENV !== 'production') {
        ...
        if (hasValue && this.props.multiple && !isNextValueArray) {
          console.error('Dropdown `value` must be an array when `multiple` is set.' + " Received type: `".concat(Object.prototype.toString.call(this.props.value), "`."));
    ...
    value: function getAutoControlledStateFromProps(nextProps, computedState, prevState) {
      ...
      if (!(0, _shallowequal["default"])(nextProps.value, prevState.__value)) {
      ...
      if (!(0, _isEqual2["default"])(getKeyAndValues(nextProps.options), getKeyAndValues(prevState.__options))) {
        derivedState.selectedIndex = (0, _getSelectedIndex["default"])({
          additionLabel: nextProps.additionLabel,
          additionPosition: nextProps.additionPosition,
          allowAdditions: nextProps.allowAdditions,
